...
if save:
    ...
    with open('../models/latent/ISOMAP_embedding.pkl', "wb") as f:
        pickle.dump(embedding, f)
        f.close()
else:
    with open('../models/latent/ISOMAP_embedding.pkl', "rb") as f:
...
ax[0].text(-8.8, 5.7, '(a)', fontsize=16)
...
ax[1].text(-8.8, 5.7, '(b)', fontsize=16)
...
if save:
    plt.savefig('latent-ISOMAP.png', bbox_inches='tight')
plt.show()
...
if save:
    ...
    table.write('valid_Isomap.fits', overwrite=True)
